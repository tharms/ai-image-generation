...
* create .env file in root directory and add `OPENAI_KEY=<YOUR-OPENAI-KEY>`
* `pip install -r requirements_versions.txt`
* `python launch.py --api-mode` parameter api-mode disables features with GPU requirements
...
entry_with_update.py  [-h] [--listen [IP]] [--port PORT]
                      ...
                      [--disable-in-browser] [--gpu-device-id DEVICE_ID] [--pure-api-mode]
